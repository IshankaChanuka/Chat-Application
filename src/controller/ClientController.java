...
public class ClientController extends Thread{
                ...
                try {
                    while (true) {
                        ...
                        for (int i = 1; i < tokens.length; i++) {
                            stringBuilder.append(tokens[i]); // new Line
                        }
                        if (msg.startsWith("IMG")) {  // image ? text Check
                            ...
                            textFlow.setStyle("-fx-font-weight: bold;"  + "-fx-background-color:#9C34C2;"+ "-fx-background-radius:10px");
    ...
    public void btnsendOnAction(ActionEvent actionEvent) throws NullPointerException, IOException {
        ...
        textFlow.setStyle("-fx-font-weight: bold;" + "-fx-background-color:#00ffff;" + "-fx-background-radius:10px");
        textFlow.setPadding(new Insets(5, 10, 5, 10));
